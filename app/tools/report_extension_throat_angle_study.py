...
def render_index(root: Path, manifest: dict[str, Any],
    ...
    curve_data = []
    colors_worst_to_best = (
        "#c0392b", "#d35400", "#e67e22", "#f39c12", "#f1c40f",
        "#c9d63b", "#9ccc45", "#66bb6a", "#26a65b", "#16856b",
    )
