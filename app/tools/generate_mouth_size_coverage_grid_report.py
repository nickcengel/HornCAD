...
<p class='muted'>Candidates are ranked by surface score v1. Previous rank and previous diagnostic score are shown beside it for direct comparison. Experimental surface score v2.1 and its multiscale −3/−6/−9 dB beamwidth quality remain side-by-side research outputs and do not alter selection.</p>
