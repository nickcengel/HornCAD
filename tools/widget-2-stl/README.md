...
- In `body` mode, the supported STL path creates a watertight body from the inner horn surface, mouth return, acoustic-normal offset shell, and driver mount flange.
