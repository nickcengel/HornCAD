...
- In `body` mode, the supported STL path creates a watertight body from the inner horn surface, acoustic-normal offset horn wall, mouth return closure, and driver mount flange.
