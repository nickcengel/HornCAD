...
class MouthSizeCoverageGridReportTests(unittest.TestCase):
    ...
    def test_candidate_columns_are_toggleable_and_details_start_hidden(self) -> None:
        ...
        self.assertIn("data-subsearch-running=", report)
        self.assertIn("showSubsearchEdgeHistory = false", report)
        self.assertIn("row.dataset.subsearchRunning === 'true'", report)
        ...
        self.assertIn("<strong>Unified queue:</strong>", report)
        self.assertIn("Phase 1 · baseline / S closure", report)
        ...
        self.assertNotIn("id='sampling-2d'", report)
        ...
        self.assertNotIn("drawSampling2d", report)
        self.assertIn("drawSampling3d", report)
        self.assertIn("`S ${sRange[0].toFixed(2)}–", report)
        ...
        self.assertIn("Phase 3 audit:", report)
        self.assertIn("Coupled completion:", report)
        self.assertNotIn("30 deg / 250-500 mm · comparable S baselines", report)
        self.assertNotIn("edge-mouth coupled closure", report)
