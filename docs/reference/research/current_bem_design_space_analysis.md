...
Snapshot through `2026-07-22T12:21:25.617059-07:00`. This analysis is **provisional** and can be regenerated as solves finish.

## Evidence inventory

- 859 unique scored physical designs across 36 mouth/coverage cells.
- Search states: cancelled: 3, complete: 132, geometry-rejected: 7, running: 2.
- Study program: `domain-map-batch-1` (running).
- S-closure certificate: complete; closed: 31, geometry-limited: 5.
- Candidate counts by coverage half-angle: 25°: 121, 30°: 49, 35°: 100, 40°: 99, 45°: 289, 50°: 201.
...
- Running: `40deg/300x300-domain-map-b01` — BEM evaluation candidate-000; 0/2 candidates complete; 10 solver workers.
...
| K≈7 / N≈20 corner | 15 | 4 | 0 | 0 | 15 | -8.48 | stop stratum: low-value boundary established |
