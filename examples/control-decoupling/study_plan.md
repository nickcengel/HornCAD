...
departure, outward rise, and secondary −6 dB error. This distinguishes a score
gain from the physical diagnostic tradeoff that produced it. Surface score v2
was developed later from the completed blinded-ranking audit and does not
retroactively alter this preregistration.
